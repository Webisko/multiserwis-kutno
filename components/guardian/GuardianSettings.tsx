  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Ustawienia strefy opiekuna firmy.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200 space-y-6">
        <div>
          ...
          <div className="space-y-3">
            {[
              { id: 'email', label: 'Powiadomienia email o postępach pracowników' },
              { id: 'expiring', label: 'Alerty o zbliżającym się wygaśnięciu uprawnień' },
              { id: 'reports', label: 'Podsumowanie tygodniowe (raport)' }
            ].map((item) => (
